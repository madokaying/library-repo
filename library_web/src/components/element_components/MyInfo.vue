...
<!--                修改背景-->
            ...
            <div class="my-avatar" @click="setAvatarData" @mouseover="changeAvatarTips = true" @mouseleave="changeAvatarTips = false">
            ...
            <div class="my-info">
                ...
                <span class="my-role" v-if="userInfo.role === '管理员'" style="background-color: #ff5700;color: white;border-radius: 6px;padding: 1px"> {{userInfo.role}}<i class="el-icon-check"></i></span>
                <span class="my-role" v-else-if="userInfo.role === '实名用户'" style="background-color: #2eff1d;color: white;border-radius: 6px;padding: 1px"> {{userInfo.role}}<i class="el-icon-circle-check"></i></span>
                <span class="my-role" v-else-if="userInfo.role === '未实名用户'" style="background-color: #ff5c5c;color: white;border-radius: 6px;padding: 1px"> {{userInfo.role}}<i class="el-icon-circle-close"></i></span>
                <span class="my-signature"><i class="el-icon-user-solid" style="font-size: 17px"></i>{{userInfo.signature}}</span>
<!--                我的消息-->
